# Footer CSS Visual Matrix: Round 12

Date: 2026-06-12
Base URL: `http://localhost:3001`
Source: `footer-css-visual-matrix-results.json`
...
| Runtime CSS module class present | Pass |
| Legacy `footer-*` runtime classes absent | Pass |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `/` | 8 | Pass | Rendered | 390x844, 768x1024, 1280x720, 1440x900 | light, dark, reduced | 2 known benign WebGL `ReadPixels` warnings recorded separately. |
...
| Runtime class ownership | Generated `Footer-module__...` classes present; legacy `footer-*` classes absent. |
...
| Footer CSS module ownership | Present on rendered Footer routes. |
| Footer-specific motion | Footer interaction transition duration remains reduced by the component-owned reduced-motion rule. |
